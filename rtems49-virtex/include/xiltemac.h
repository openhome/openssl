...
#define XILTEMAC_TX_SFIFO_LENGTH     64
...
#define XTE_CAM_REGISTER_COUNT  4
...
#define XTE_PREV_TX_BYTES_MAX 8
...
struct XilTemac
{
  ...
  int                   iIsPresent;
  /** 8 byte tx buffer for alignment */
  uint8_t               iPrevTx[XTE_PREV_TX_BYTES_MAX]; 
  uint32_t              iPrevTxBytes;
  uint32_t              iStatusFifoOutstanding;
};
