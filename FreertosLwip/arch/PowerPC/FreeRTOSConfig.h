...
#define configCPU_CLOCK_HZ				( ( unsigned long ) 300000000 )	/* Clock setup from start.asm in the demo application. */
#define configTICK_RATE_HZ				( (portTickType) 1000 )
#define configMAX_PRIORITIES			( ( unsigned portBASE_TYPE ) 151 )
...
#define configASSERT(x)                 if(!(x)) { assert_failed(__FILE__, __LINE__); }
